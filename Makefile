LANGUAGE_NAME := tree-sitter-gno
HOMEPAGE_URL := https://github.com/tree-sitter/tree-sitter-gno
VERSION := 0.25.0
...
install: all
	install -d '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gno '$(DESTDIR)$(INCLUDEDIR)'/tree_sitter '$(DESTDIR)$(PCLIBDIR)' '$(DESTDIR)$(LIBDIR)'
...
ifneq ($(wildcard queries/*.scm),)
	install -m644 queries/*.scm '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gno
endif
...
uninstall:
	...
	$(RM) -r '$(DESTDIR)$(DATADIR)'/tree-sitter/queries/gno
